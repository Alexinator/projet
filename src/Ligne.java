...
public class Ligne {
	...
	/**
	 * Constructeur
	 * @param nom = le numéro de la ligne
	 * @param source = station de départ de la ligne
	 * @param destination = station d'arrivée de la ligne
	 * @param type = bus, tram, métro
	 * @param attenteMoyenne = durée moyenne passée en station (une seule fois par ligne)
	 */
